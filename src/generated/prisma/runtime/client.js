...
var B = (e, t, r) => (
    ...
    hi(
      t || !e || !e.__esModule
        ? Jt(r, "default", { value: e, enumerable: !0 })
        : r,
      e,
    )
  ),
...
var zs = q((T) => {
  ...
  function ed(e = 32) {
    ...
    if (Ke.crypto && typeof Ke.crypto.randomBytes == "function")
      return Ke.crypto.randomBytes(e);
...
var ra = q((R) => {
  ...
  for (let e = 0, t = It, r = 1, n = 0; e < 24; e++) {
    ...
    for (let o = 0; o < 7; o++)
      (t = ((t << It) ^ ((t >> nd) * od)) % id),
        t & rd && (i ^= It << ((It << BigInt(o)) - It));
    Xs.push(i);
  }
  var [sd, ad] = (0, Ot.split)(Xs, !0),
    Ws = (e, t, r) =>
      r > 32 ? (0, Ot.rotlBH)(e, t, r) : (0, Ot.rotlSH)(e, t, r),
    Ks = (e, t, r) =>
      r > 32 ? (0, Ot.rotlBL)(e, t, r) : (0, Ot.rotlSL)(e, t, r);
  function ea(e, t = 24) {
...
var Ci = {
  enabled:
    !Ti && Si == null && vi !== "dumb" && ((Kr != null && Kr !== "0") || Ai),
};
function A(e, t) {
...
function vu(e) {
  let t = {
    ...
    r = (...n) => {
      ...
      if (
        (n.length !== 0 && pt.push([o, ...n]),
        pt.length > Tu && pt.shift(),
        dt.enabled(o) || i)
      ) {
...
var Mu = (e) => e,
  ...
  y = {
    ...
    util: {
      ...
      objId: function (e) {
        return (
          e.__id || Object.defineProperty(e, "__id", { value: ++Fu }), e.__id
        );
      },
        ...
        for (let w = 0; w < k.length; ++w) {
          ...
          for (let L = n, pe = i; L < t.length; pe += t[L].length, ++L) {
            ...
            if (Oe && L != t.length - 1) {
              ...
              for (
                let Xl = t.length;
                a < Xl && (l < d || (!t[a].type && !t[a - 1].greedy));
                ++a
              )
...
function ju(
  ...
  if (u && c) {
    ...
    (s.functionName = `${d.code})`),
      (s.location = a),
      n ||
        (u = u.mapLineAt(a.lineNumber, (m) => m.slice(0, d.openingBraceIndex))),
...
function ms(e, t, r) {
  if (typeof e != "object")
    throw new C(`Expected an object, but got '${typeof e}'`);
  let n = {};
  for (let [i, o] of Pp(t))
    switch (o.type) {
      case "affectedRows":
...
function Tn(e, t, r, n) {
  switch (r.type) {
    ...
    case "enum": {
      ...
      let o = i[`${e}`];
      if (o === void 0)
        throw new C(`Value '${e}' not found in enum '${r.name}'`);
      return o;
    }
    default:
...
function wd(e) {
  !ve || ve.length < e
    ? ((ve = Buffer.allocUnsafe(e * hd)),
      Fn.webcrypto.getRandomValues(ve),
      (Ye = 0))
...
function Pd(e) {
  let t = Ed(),
    r =
      ...
      (typeof Ft.default < "u" ? Ft.default : null);
  ...
  if (Ft.default?.randomBytes)
    return () => Ft.default.randomBytes(1).readUInt8() / 255;
...
function Sd(e, t = ga) {
  ...
  if (e > ma)
    throw new Ce(
      ...
      `Cannot encode a time larger than ${ma}: ${e}`,
    );
  ...
  let r,
    n = "";
  for (let i = t; i > 0; i--)
    (r = e % _t), (n = fa.charAt(r) + n), (e = (e - r) / _t);
  return n;
}
function vd() {
...
function Od(e, t) {
  if (t.pagination) {
    ...
    if ((r !== null && r > 0) || n === 0 || (i !== null && !ze(e, i)))
      return null;
  }
  ...
  async interpretNode(t, r) {
    switch (t.type) {
      ...
      case "concat": {
        ...
        return {
          value: n.length > 0 ? n.reduce((i, o) => i.concat(Yn(o)), []) : [],
        };
      }
      case "sum": {
        let n = await Promise.all(
      ...
      case "execute": {
        ...
        for (let o of n) {
          ...
          i += await this.#u(s, r.queryable, () =>
            r.queryable
              .executeRaw(Xn(s))
              .catch((a) => (t.args.type === "rawSql" ? En(a) : We(a))),
          );
        }
        return { value: i };
      }
        ...
        for (let o of n) {
          let s = Aa(o, r.sqlCommenter),
            a = await this.#u(s, r.queryable, () =>
              r.queryable
                .queryRaw(Xn(s))
                .catch((l) => (t.args.type === "rawSql" ? En(l) : We(l))),
            );
          i === void 0
            ? (i = a)
      ...
      case "join": {
        ...
        return {
          value: Qd(n, o, t.args.canAssumeStrictEquality),
          lastInsertId: i,
        };
      }
      case "transaction": {
      ...
      case "process": {
        ...
        return (
          Ra(o, r.scope, r.generators), { value: Cr(n, o), lastInsertId: i }
        );
      }
      case "initializeRecord": {
        ...
        for (let [o, s] of Object.entries(t.args.fields))
          i[o] = Hd(s, n, r.scope, r.generators);
      ...
      case "mapRecord": {
        ...
        for (let [s, a] of Object.entries(t.args.fields))
          o[s] = Gd(a, o[s], r.scope, r.generators);
      ...
      let n = async () => {
        ...
        try {
          ...
          (t.status = r),
            ...
            this.closedTransactions.length > om &&
  ...
  async request(t, { interactiveTransaction: r, customDataProxyFetch: n }) {
    ...
    if (al(t)) s = ll(t);
      ...
      h
        ...
        : (ce("query plan cache miss"),
          (s = this.#f(u, p, o)),
          d && this.#i?.setSingle(p, s));
    }
    try {

...
import { CustomerDailyUsage } from "@/lib/types";
      ...
      return (
        <div className="rounded-lg border border-slate-200 bg-white/95 p-3 text-xs shadow-lg backdrop-blur-xs dark:border-slate-800 dark:bg-slate-900/95">
          ...
          <div className="mt-2 space-y-1">
            ...
            <div className="flex items-center justify-between gap-4">
              <span className="text-indigo-600 dark:text-indigo-400">Upload:</span>
    ...
    <div className="h-[280px] w-full">
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          />
          <Bar dataKey="downloadBytes" name="downloadBytes" fill="#3b82f6" radius={[4, 4, 0, 0]} stackId="a" />
          <Bar dataKey="uploadBytes" name="uploadBytes" fill="#8b5cf6" radius={[4, 4, 0, 0]} stackId="a" />
        </BarChart>
      </ResponsiveContainer>
    </div>
  );
